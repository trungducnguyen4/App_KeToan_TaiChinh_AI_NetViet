...
export default function BankCreditCreateScreen() {
  return (
    <AppShell activeModule="cash">
      <div className="workspace">
        <div className="breadcrumb">
          ...
          <span>/</span>
          <a className="breadcrumb-link" href="/modules/cash/bank-credits">
            Báo có ngân hàng
          </a>
          <span>/</span>
          <span>Thêm mới</span>
        ...
        <div className="section-title">
          <h2>Báo có ngân hàng</h2>
          <div className="topbar-actions">
            <button className="button primary" type="button">
              <AppIcon name="Save" />
              Lưu (F8)
            </button>
            <a className="button danger" href="/modules/cash/bank-credits">
              Hủy
            </a>
          </div>
        </div>
        ...
        <section className="panel">
          ...
          <form className="form-grid">
            <label className="form-field sm">
              <span>Mã CT</span>
              <input className="field" defaultValue="BC1" />
            </label>
            <label className="form-field sm">
              <span>Ngày CT</span>
